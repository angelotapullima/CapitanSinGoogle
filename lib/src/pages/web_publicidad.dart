...
class PublicidadWeb extends StatefulWidget {
  final String web;
  final String titulo;
  PublicidadWeb({@required this.web, @required this.titulo});
  @override
  _PublicidadWebState createState() => _PublicidadWebState();
}

class _PublicidadWebState extends State<PublicidadWeb> {
